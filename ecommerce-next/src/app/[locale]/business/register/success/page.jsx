  ...
  return (
    ...
    >
      <div className="grid gap-5 md:grid-cols-2">
        <Input name="businessName" label="Business Name" value={form.businessName} onChange={handleChange} />
        <Input name="ownerName" label="Owner Name" value={form.ownerName} onChange={handleChange} />
        <Input name="businessType" label="Business Type" value={form.businessType} onChange={handleChange} />
        <Input name="category" label="Product Category" value={form.category} onChange={handleChange} />
        ...
        <Input name="province" label="Province" value={form.province} onChange={handleChange} />
